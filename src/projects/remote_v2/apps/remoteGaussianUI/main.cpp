...
void resetScene(RemoteAppArgs myArgs, int rendering_width, int rendering_height,
                BasicIBRScene::Ptr &scene, RemotePointView::Ptr &pointBasedView,
  ...
  generalCamera->setup(
      ...
      Viewport(0, 0, (float)usedResolution.x(), (float)usedResolution.y()),
      nullptr);
...
int main(int ac, char **av) {
  ...
  sibr::Window window(PROGRAM_NAME, sibr::Vector2i(50, 50), myArgs,
                      getResourcesDirectory() + "/remote/" + PROGRAM_NAME +
                          ".ini");
